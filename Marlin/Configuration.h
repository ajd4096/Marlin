...
#define STRING_VERSION_CONFIG_H "2012-07-02-00" //Personal revision number for changes to THIS file.
#define STRING_CONFIG_H_AUTHOR "ajd4096" //Who made the changes.
